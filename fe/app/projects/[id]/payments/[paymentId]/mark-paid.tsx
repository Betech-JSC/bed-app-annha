...
export default function MarkPaidPaymentScreen() {
    ...
    const loadPayment = async () => {
        try {
            ...
            if (error.response?.status === 403) {
                ...
                Alert.alert("Lỗi", error.response?.data?.message || "Không thể tải thông tin thanh toán");
                router.back();
            }
        } finally {
            setLoading(false);
    ...
    const handleSubmit = async () => {
        ...
        try {
            setSubmitting(true);
            const response = await paymentApi.markAsPaidByCustomer(id!, Number(paymentId), {
                        ...
                        {payment && (
                            <>
                                <View style={styles.infoCard}>
                                    ...
                                    <Text style={styles.infoSubtext}>Đợt {payment.payment_number}</Text>
                                </View>
